...
import dairyfreedining.composeapp.generated.resources.filter_add_all
...
fun FilterSection(
    ...
    Row(
        ...
        Text(text = sectionName.uppercase())

        val isNoCategoriesSelected = selectedItems.isEmpty()
        ...
        OutlinedButton(
            ...
            Row(
                ...
                Text(
                    text = stringResource(
                        if (isNoCategoriesSelected) Res.string.filter_add_all
                        else Res.string.filter_clear_all
                    )
                )

                Icon(
                    if (isNoCategoriesSelected) Icons.Filled.Add else Icons.Filled.Close,
